...
A GitHub Action is available in the [template project](https://github.com/gohypermode/sample-project) to handle the build of your project's functions. This Action must complete successfully before your functions deploy.
