...
A GitHub Action is included in the [template project](https://github.com/gohypermode/sample-project) to handle the build of your project's functions. This Action must complete successfully before your functions can be deployed.
...
For [auto-deployed models](/define-models#auto-deployed-models), a dedicated instance of the model is deployed.