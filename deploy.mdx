...
A GitHub Action is included in the [template project](https://github.com/hypermodeAI/template-project) to build your project's functions.  On success, the action deploys your functions to Hypermode when committing or merging to the branch defined in the Hypermode Console.```
