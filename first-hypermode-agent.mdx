...
![Sidekick](/images/tutorials/first-hypermode-agent/tom-anderson.png)
...
Tom is configured to connect to Google Calendar. To enable other connections
...
to explore creating new agents with new capabilities and adding other
