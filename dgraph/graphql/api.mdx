...
title: API Endpoints
description:
  This documentation presents the Admin API and explains how to run a Dgraph
...
[deployment guide](https://dgraph.io/docs/deploy/).
...
to know more about this, see the
[quick start](https://dgraph.io/docs/graphql/quick-start/) and
[schema docs](https://dgraph.io/docs/graphql/schema/).
...
- The `state` query returns the current state of the cluster and group
  ...
  [here](./deploy/dgraph-zero.md#more-about-the-state-endpoint).
...
Enterprise Features like ACL, Backups and Restore are also available using the
GraphQL API at `/admin` endpoint.

- [ACL](./enterprise-features/access-control-lists.md#accessing-secured-dgraph)
- [Backups](./enterprise-features/binary-backups.md#create-a-backup)
- [Restore](./enterprise-features/binary-backups.md#online-restore)
