...
description:
  Given an authentication mechanism and a signed JSON Web Token (JWT), the
  `@auth` directive tells Dgraph how to apply authorization.
---
...
For example, the todo app might allow anyone, logged in or not, to view any
...
Maybe some todos can be marked as public and users you aren't logged in can see
those.
