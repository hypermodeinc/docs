...
description:
  Mutations with authorization work like queries. But because mutations involve
  a state change in the database, it's important to understand when the
  authorization rules are applied and what they mean.
"og:title": "Mutations and GraphQL Authorization - Dgraph"
---
...
item, it would have to satisfy the rules to update the author _and_ the rules to
