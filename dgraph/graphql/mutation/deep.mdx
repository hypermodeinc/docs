...
description:
  Perform deep mutations at multiple levels. Deep mutations don't alter linked
  objects, but add nested new objects or link to existing objects.
"og:title": "Deep Mutations - Dgraph"
---
