...
description:
  Update mutations let you to update existing objects of a particular type. With
  update mutations, you can filter nodes and set or remove any field belonging
  to a type.
---
...
[link](https://github.com/dgraph-io/dgraph/blob/main/graphql/resolve/update_mutation_test.yaml)
for more examples.
