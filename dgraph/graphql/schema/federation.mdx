---
title: Graph Federation
description:
  Dgraph supports Apollo federation so that you can create a gateway GraphQL
...
can only be used on extended type definitions. For example, it's used in the
