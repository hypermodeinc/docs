...
description:
  Dgraph accepts GraphQL documentation comments, which get passed through to the
  generated API and shown as documentation in GraphQL tools.
"og:title": "Documentation and Comments - Dgraph"
---
...
![Schema Documentation On Types](/images/dgraph/graphql/authors1.png)

Schema Documentation on Types

![Schema Documentation On Custom Directive](/images/dgraph/graphql/CustomDirectiveDocumentation.png)
