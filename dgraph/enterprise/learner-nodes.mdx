...
title: Learner Nodes
description:
  Learner nodes let you spin-up read-only replica instance to serve best-effort
  queries faster
"og:title": "Learner Nodes - Dgraph"
---
...
_You want to achieve low latency for clients in a remote geographical region,
distant from your Dgraph cluster._
