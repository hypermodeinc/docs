...
<Note>
  ...
  [v1.1.1](https://github.com/hypermodeinc/dgraph/releases/tag/v1.1.1). For
...
<Tip>
  ...
  Docker](https://github.com/hypermodeinc/dgraph/blob/main/contrib/config/vault/docker/README.md).
</Tip>
