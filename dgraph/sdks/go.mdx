...
The full [GoDoc](https://pkg.go.dev/github.com/dgraph-io/dgo/v250) contains
...
You can use either `Open` or `NewClient` to connect to Dgraph Cloud. Note
`DialCloud` is marked deprecated and will be removed in later versions.
