...
DQL query string, and a map (optional, could be empty) of any variables that you
...
[transaction](./clients#transactions) conflicts in Dgraph.
...
[dgraph4j repository](https://github.com/dgraph-io/dgraph4j). This particular
...
time, the first one succeeds, while the other will get the
