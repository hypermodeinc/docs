...
<Tip>
  ...
  here](https://github.com/dgraph-io/dgraph.net). Follow the [install
  instructions](https://github.com/dgraph-io/dgraph.net#install) to get it up
  and running.
</Tip>
...
`LoginRequest()`, which will allow the users to login to a specific namespace.
