...
[Predicates i18n](./dql-schema.md#predicates-i18n) for more info.
...
[value variables](./query-language/value-variables). The variable is a map from
the edge target to the facet value.
...
[values propagate](./query-language/value-variables.md#variable-propagation).
