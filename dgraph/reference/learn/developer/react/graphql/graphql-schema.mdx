...
description:
  "How to Build a Message Board App in React. Step 2: GraphQL schema - translate
  the schema design to the GraphQL SDL (Schema Definition Language)."
---
...
![data model sketch](/images/message-board/schema-sketch.png)
...
this case, `Post` nodes. It also gives those nodes what GraphQL calls _fields_,
...
application data graph, and you can start to make a pretty faithful translation
of the types in your schema design. However, there's a bit more that you'll need
in the API for this app.
