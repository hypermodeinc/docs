...
- [what a graph is](./01-dm-101-introduction),
- how a graph differs from a [relational model](./02-relational-data-model),
- [how to model a graph](./03-graph-data-model),
- and [how to query a graph](./05-graph-query),
