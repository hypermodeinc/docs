...
In the [previous tutorial](./tutorial-4/index), we learned about using
...
[first tutorial](./tutorial-1/index)._
...
[check out the third tutorial](./tutorial-3/index) of the series._
...
_Note: Refer to [the third tutorial](./tutorial-3/index), if you want to know
about comparator functions like `eq` in detail._
...
We discussed in the [third tutorial](./tutorial-3/index) that there five
...
_Note: Check out [the first tutorial](./tutorial-1/index) if the query syntax,
in general, is not familiar to you_
...
It's also important to notice that the term search functions (`anyofterms` and
