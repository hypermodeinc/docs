...
It's easy to get started with Dgraph. Follow these simple steps to deploy your
graph and run your first query. Use a serverless graph on the Hypermode platform
or start locally.
