...
description:
  The following sample apps show some of the possibilities when you build your
  app with GraphQL and Dgraph database
---
...
them to Dgraph Cloud — a fully-managed GraphQL backend database service that
