...
description:
  Use React Router to build a message board app. A routing library in the UI
  interprets the URL path and renders an appropriate page for that path.
"og:title": "Routing in React - Dgraph"
---
