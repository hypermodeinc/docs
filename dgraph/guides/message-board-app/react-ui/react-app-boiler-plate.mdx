...
description:
  Jump right in thanks to the Message Board App Tutorial repo on GitHub. Get
  started with your Message Board App in React with GraphQL.
---
...
![running boiler plate app](/images/dgraph/guides/message-board-app/app-boilerplate.png)
