...
description:
  Apollo client provides a connection to the GraphQL endpoint & a GraphQL cache
  that lets you manipulate the visual state of the app from the internal cache
"og:title": "Connect to Dgraph Cloud - Dgraph"
---
