...
description:
  In this step, you can move on to the GraphQL queries that get the data to
  render the main pages, thanks to Apollo Client, Dgraph Cloud, and React
  routing.
...
![post list component](/images/dgraph/guides/message-board-app/post-list-component.png)
...
![post component](/images/dgraph/guides/message-board-app/post-component.png)
