...
description:
  GraphQL queries are about starting points and traversals. From simple queries
  to deep filters, dive into the queries use in the message board app.
"og:title": "GraphQL Queries - Dgraph"
---
...
comments.
![query a post and follow relationships](/images/dgraph/guides/message-board-app/post2-search-in-graph.png)
...
![Graph schema sketch](/images/dgraph/guides/message-board-app/user1-post-search-in-graph.png)
