...
description:
  "Building a Message Board App in React. Step 2: With the schema defined, it’s
  just one step to get a running GraphQL backend for the app."
"og:title": "Deploy the Schema - Dgraph"
---
...
![Deploy Dgraph Cloud schema](/images/dgraph/guides/message-board-app/dgraph-cloud-deploy-schema-success.png)
