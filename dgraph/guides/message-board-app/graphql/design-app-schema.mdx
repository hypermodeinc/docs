...
![App UI requirements](/images/dgraph/guides/message-board-app/UI-components.gif)
...
between them.
![Graph schema sketch](/images/dgraph/guides/message-board-app/schema-inital-sketch.png)
...
![first-posts-in-graph](/images/dgraph/guides/message-board-app/first-posts-in-graph.png)
...
![more users and posts](/images/dgraph/guides/message-board-app/user2-posts-in-graph.png)

Next the users read some posts and start making and replying to comments.
![users, posts and comments](/images/dgraph/guides/message-board-app/comments-in-graph.png)
...
![query a user](/images/dgraph/guides/message-board-app/user1-search-in-graph.png)
...
![query a user and their posts](/images/dgraph/guides/message-board-app/user1-post-search-in-graph.png)
...
![query a post and follow edges](/images/dgraph/guides/message-board-app/post2-search-in-graph.png)
...
![Graph schema sketch with data](/images/dgraph/guides/message-board-app/schema-sketch.png)
...
and upload that to Dgraph. That'll give you a running GraphQL API and you'll
look at the queries and mutations that form the data of your app.
