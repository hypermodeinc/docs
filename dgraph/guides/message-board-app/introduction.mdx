...
"og:title": "Build a Message Board App in React - Dgraph"
---
...
![message board app main page](/images/dgraph/guides/message-board-app/main-screenshot.png)
...
![App post page](/images/dgraph/guides/message-board-app/post-screenshot.png)
...
is inherently a _graph_ (a network of data nodes) and where GraphQL queries let
