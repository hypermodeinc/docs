...
description:
  Use the @auth directive to limit access to the user’s to-dos. This step in the
  GraphQL tutorial walks you through authorization rules.
"og:title": "Authorization Rules - Dgraph"
---
