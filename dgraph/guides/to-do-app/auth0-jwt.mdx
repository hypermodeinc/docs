...
![Dashboard](/images/dgraph/guides/to-do-app/dashboard.png)
...
![Rule](/images/dgraph/guides/to-do-app/rule.png)
...
![Certificate](/images/dgraph/guides/to-do-app/certificate.png)
...
![Token](/images/dgraph/guides/to-do-app/token.png)

Now go to [jwt.io](https://jwt.io) and paste your token there.

![jwt](/images/dgraph/guides/to-do-app/jwt.png)
