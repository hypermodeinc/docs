...
description:
  In just two steps on Dgraph Cloud (deployment & schema), you get a GraphQL API
  that you can easily use in any app.
"og:title": "Deploying on Dgraph Cloud - Dgraph"
---
...
![Dgraph Cloud: Get Started](/images/dgraph/guides/to-do-app/cloud-1.png)

Let's go ahead and launch a new deployment.

![Dgraph Cloud: Create deployment](/images/dgraph/guides/to-do-app/cloud-2.png)
...
Let's set it up in AWS, in the US region, and click on the _Launch_ button.

![Dgraph Cloud: Deployment created](/images/dgraph/guides/to-do-app/cloud-3.png)
