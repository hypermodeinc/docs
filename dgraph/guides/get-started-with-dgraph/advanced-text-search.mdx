...
[first tutorial of the series before proceeding.](./introduction)_
...
[the previous tutorial.](./string-indicies)_
...
_Note: Refer to the [previous tutorial](./string-indicies) if you're not sure
...
[the first tutorial](./introduction) of the series._
...
_Note: Refer to [the first tutorial](./introduction) if you're not familiar with
the query structure in general_ Success!
