...
[first tutorial](/introduction) to learn the basics of mutations in Dgraph._
...
about traversal queries like the above one._
...
_Note: Refer to the [third tutorial](./types-and-operations) of the series to
