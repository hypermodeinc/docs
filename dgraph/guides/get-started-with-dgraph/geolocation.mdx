...
[first tutorial](/introduction.md) to learn the basics of mutations in Dgraph._
...
_Note: Check the [second tutorial](./basic-operations.md) if you want to learn
...
_Note: Check out the [previous tutorial](./types-and-operations.md) to know more
...
the hotels. You can visit our [third tutorial](./types-and-operations.md) of the
...
_Note: Refer to the [third tutorial](./types-and-operations.md) of the series to
