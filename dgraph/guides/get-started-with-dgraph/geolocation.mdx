...
![model](/images/dgraph/guides/get-started-with-dgraph/b-paris.png)
...
![model](/images/dgraph/guides/get-started-with-dgraph/c-delhi.jpg)
...
![model](/images/dgraph/guides/get-started-with-dgraph/a-graph.jpg)
...
<Note>
  ...
  type system for nodes in a future tutorial. Check [this page from the
  documentation site](https://dgraph.io/docs/query-language/#type-system), if
  you want to explore type system feature for nodes
</Note>
...
![full graph](/images/dgraph/guides/get-started-with-dgraph/d-full-graph.png)
...
![type detection](/images/dgraph/guides/get-started-with-dgraph/e-schema.png)
...
![geo-index](/images/dgraph/guides/get-started-with-dgraph/f-index.png)
...
![geo-index](/images/dgraph/guides/get-started-with-dgraph/g-near-1.png)
...
![geo-index](/images/dgraph/guides/get-started-with-dgraph/h-near-2.png)

Let's add a `hash` index to the `loc_type` and re-run the query.

![geo-index](/images/dgraph/guides/get-started-with-dgraph/i-near-3.png)

![geo-index](/images/dgraph/guides/get-started-with-dgraph/j-near-4.png)
...
![geo-index](/images/dgraph/guides/get-started-with-dgraph/k-near-5.png)
...
![geo-index](/images/dgraph/guides/get-started-with-dgraph/l-float-index.png)
...
![geo-index](/images/dgraph/guides/get-started-with-dgraph/m-final-result.png)
