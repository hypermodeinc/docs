...
In the [previous tutorial](./tutorial-2/index), we learned about CRUD operations
...
<iframe
  width="560"
  height="315"
  src="https://www.youtube.com/embed/f401or0hg5E"
...
![main graph model](/images/dgraph/guides/get-started-with-dgraph/a-main-graph.JPG)

The above graph has three entities: Author, Blog posts, and Tags. The nodes in
the graph represent these entities. For the rest of the tutorial, we'll call the
...
Go to Ratel, click on the mutate tab, paste the following mutation, and click
Run.
...
![rating-blog-rating](/images/dgraph/guides/get-started-with-dgraph/l-fullgraph-2.png)
...
![rating-blog-rating](/images/dgraph/guides/get-started-with-dgraph/a-initial.png)
...
Dgraph's [v1.1 release](https://blog.dgraph.io/post/release-v1.1.0/) introduced
...
![authors](/images/dgraph/guides/get-started-with-dgraph/a-find-rating-2.png)

Refer to the [first episode](./tutorial-1/index) if you have any questions
related to the structure of the query in general.

We have 3 authors in total in our dataset. Now, let's find the best authors.
...
criteria (e.g., rating > 4.0). You can do this by using Dgraph's built-in
...
![index missing](/images/dgraph/guides/get-started-with-dgraph/b-index-missing.png)

We got an error! The index for the `rating` predicate is missing. You cannot
...
explicitly added to a predicate when they are required. That is, only when you
need to query for the value of a predicate.
...
![Add schema](/images/dgraph/guides/get-started-with-dgraph/c-add-schema.png)

We successfully added the index for `rating` predicate! Let's rerun our previous
query.

![rating](/images/dgraph/guides/get-started-with-dgraph/d-rating-query.png)
...
![rating-blog-rating](/images/dgraph/guides/get-started-with-dgraph/e-rating-blog.png)

_Check out our [previous tutorial](./tutorial-2/index.md) if you have questions
around graph traversal queries._
...
![rating-blog-rating](/images/dgraph/guides/get-started-with-dgraph/m-four-blogs.png)

_Note: Author nodes are in blue, blogs posts in green, and tags in pink._

We have two authors, four blog posts, and their tags in the result. If you take
a closer look at the result, there's a blog post with 12 dislikes.

![Dislikes](/images/dgraph/guides/get-started-with-dgraph/i-dislikes-2.png)
...
_Hey, traverse the `published` edge, but only return those blogs with fewer than
10 dislikes_
...
![rating-blog-rating](/images/dgraph/guides/get-started-with-dgraph/n-three-blogs.png)
...
![tags](/images/dgraph/guides/get-started-with-dgraph/o-tags.png)
...
![string index](/images/dgraph/guides/get-started-with-dgraph/p-string-index-2.png)
...
run the above comparators, the query fails.

Although, any of the five string type indexes are compatible with the `eq`
function, the `hash` index used with the `eq` comparator would normally be the
most performant.

Let's add the `hash` index to the `tag_name` predicate.

![string index](/images/dgraph/guides/get-started-with-dgraph/m-hash.png)
...
![string index](/images/dgraph/guides/get-started-with-dgraph/q-devrel-2.png)
...
![string index](/images/dgraph/guides/get-started-with-dgraph/r-reverse-2.png)
...
![string index](/images/dgraph/guides/get-started-with-dgraph/r-reverse-1.png)
...
![uid index](/images/dgraph/guides/get-started-with-dgraph/s-devrel-blogs.png)

![uid index](/images/dgraph/guides/get-started-with-dgraph/s-devrel-blogs-2.png)
...
![uid index](/images/dgraph/guides/get-started-with-dgraph/t-reverse-published.png)
...
![uid index](/images/dgraph/guides/get-started-with-dgraph/u-author-reverse-1.png)

![uid index](/images/dgraph/guides/get-started-with-dgraph/u-author-reverse-2.png)
