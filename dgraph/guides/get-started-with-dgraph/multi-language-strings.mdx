...
In the [previous tutorial](./tutorial-3/index), we learned about Datatypes,
...
<iframe
  width="560"
  height="315"
  src="https://www.youtube.com/embed/_lDE9QXHZC0"
...
![model](/images/dgraph/guides/get-started-with-dgraph/a-graph-model.jpg)
...
[first tutorial](/tutorial-1/index.md) to learn basics of mutation in Dgraph._

Here's our Graph!

![full graph](/images/dgraph/guides/get-started-with-dgraph/a-full-graph.png)
...
![full graph](/images/dgraph/guides/get-started-with-dgraph/c-schema.png)
...
more about traversal queries like the above one_
...
![full graph](/images/dgraph/guides/get-started-with-dgraph/b-comments.png)

But can we fetch the reviews based on their language? Can we write a query which
says: _Hey Dgraph, can you give me only the reviews written in Chinese?_
...
_Note: If you're not clear about basic terminology like `predicates`, do read
the [first tutorial](./tutorial-1/index.md)._

Let's run the above mutation.

Go to the mutate tab, paste the mutation, and click Run.

![lang error](/images/dgraph/guides/get-started-with-dgraph/d-lang-error.png)
...
![lang error](/images/dgraph/guides/get-started-with-dgraph/e-update-lang.png)

Let's re-run the mutation.

![lang error](/images/dgraph/guides/get-started-with-dgraph/f-mutation-success.png)
...
In the [previous article](./tutorial-3/index.md), we learned about using the
...
![hash index](/images/dgraph/guides/get-started-with-dgraph/g-hash.png)
...
![hash index](/images/dgraph/guides/get-started-with-dgraph/h-comment.png)
...
![Japanese](/images/dgraph/guides/get-started-with-dgraph/i-japanese.png)
...
![Russian](/images/dgraph/guides/get-started-with-dgraph/j-russian.png)
...
![Russian](/images/dgraph/guides/get-started-with-dgraph/k-star.png)
...
![Russian](/images/dgraph/guides/get-started-with-dgraph/l-russian.png)
...
![Russian](/images/dgraph/guides/get-started-with-dgraph/m-sushi.png)
