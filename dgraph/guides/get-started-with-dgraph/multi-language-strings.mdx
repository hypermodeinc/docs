...
"og:title": "Get Started with Dgraph -  Multi-language strings - Dgraph"
---
...
[first tutorial](/introduction) to learn basics of mutation in Dgraph._
...
_Note: Check out the [previous tutorial](./types-and-operations) to know more
...
_Note: Check the [second tutorial](./basic-operations) if you want to learn more
about traversal queries like the above one_
...
the [first tutorial](./introduction)._
