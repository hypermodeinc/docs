...
[first tutorial](/introduction.md) to learn basics of mutation in Dgraph._
...
the [first tutorial](./introduction.md)._
...
In the [previous article](./types-and-operations.md), we learned about using the
