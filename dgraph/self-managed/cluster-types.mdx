...
[Docker Compose](https://github.com/hypermodeinc/dgraph/blob/main/contrib/config/docker/docker-compose.yml)
and
[Kubernetes](https://github.com/hypermodeinc/dgraph/tree/main/contrib/config/kubernetes/dgraph-single)
for a 2-node cluster. You can also run Dgraph directly on your host machines.

![2-node cluster](/images/dgraph/self-managed/deploy-guide-1.png)
...
We provide sample configuration for both
[Docker Compose](https://github.com/hypermodeinc/dgraph/blob/main/contrib/config/docker/docker-compose-ha.yml)
and
[Kubernetes](https://github.com/hypermodeinc/dgraph/tree/main/contrib/config/kubernetes/dgraph-ha)
...
![Dgraph cluster image](/images/dgraph/self-managed/deploy-guide-2.png)
