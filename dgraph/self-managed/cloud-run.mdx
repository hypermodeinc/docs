---
title: "Deploying Dgraph on Google Cloud Run"
description: "How to guiide for deploying Dgraph standalone on Google Cloud Run and migrating from Dgraph Cloud"
mode: "wide"
...
![](/images/dgraph/guides/cloud-run/cloud-run-dashboard.png)
...
![](/images/dgraph/guides/cloud-run/auth-docker.png)
...
![](/images/dgraph/guides/cloud-run/docker-build.png)
...
![](/images/dgraph/guides/cloud-run/cloud-run-deployed.png)
...
![](/images/dgraph/guides/cloud-run/ratel-setup.png)

![](/images/dgraph/guides/cloud-run/ratel-web-ui.png)
