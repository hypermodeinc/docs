...
You can create a Dgraph [configuration](./deploy/config) files for Alpha server
and Zero server with Helm chart configuration values, `<MY-CONFIG-VALUES>`. For
more information about the values, see the latest
...
<TabItem value="Ingress Resource">
