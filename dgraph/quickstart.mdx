...
mutations. For an interactive experience, take the
...
2. Paste the following:
   ...
   are stored as [Nodes](./dgraph-glossary.md#node) in Dgraph.
...
1. In the **Schema** page, select **Predicates**. Dgraph creates and displays
   ...
   [predicate](./dgraph-glossary.md#predicate) is Dgraph internal representation
   of a node attribute or a relation.
...
- Go to [Clients](/clients) to see how to communicate with Dgraph from your app.
