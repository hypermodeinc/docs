...
"og:title": "Query Structure - Dgraph"
---
...
![DQL Query with parameterization](/images/dgraph/query-syntax-1.png)
...
![DQL Query without parameters](/images/dgraph/query-syntax-2.png)
...
![DQL response structure](/images/dgraph/query-syntax-3.png)
