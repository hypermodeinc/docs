...
"og:title": "Switch Dgraph Cloud Schema Modes - Dgraph Cloud"
---
...
<Note>
  ...
  predicate, perform an [`alter` operation](/dgraph/http#alter-the-dql-schema)
...
- Directly altering the schema with the
  [`alter`](/dgraph/http/#alter-the-database) HTTP and gRPC endpoints
