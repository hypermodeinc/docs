...
1. After you have signed up and verified you email, log into
   ...
   ![first login empty
dashboard](https://graphql.dgraph.io/images/cloud/dgraph-cloud-empty-dashboard.png)
...
![launch a backend](https://graphql.dgraph.io/images/cloud/dgraph-cloud-launch-backend.png)

3. click **Launch** and your backend will be deployed in a few seconds.

![Dgraph Cloud console](https://graphql.dgraph.io/images/cloud/dgraph-cloud-backend-live.png)
