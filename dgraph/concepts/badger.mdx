...
[Badger](https://github.com/hypermodeinc/badger) is a key-value store developed
and maintained by Dgraph. It is also open source, and it's the backing store for
Dgraph data.
