...
libraries which are embedded in larger programs to efficiently and idomatically
call Dgraph.
...
GraphQL client, GUI, tool, or library will work well with Dgraph, and it's the
