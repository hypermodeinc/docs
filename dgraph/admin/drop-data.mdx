...
As an example, if your GraphQL endpoint is `https://<domain>/graphql`, then the
admin endpoint for schema is at `https://<domain>/admin/slash`.

This endpoint requires [Authentication](/dgraph/cloud/authentication).
