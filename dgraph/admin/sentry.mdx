...
terms, it's a dial-home service but also has a rich feature set including event
...
- For runtime panics, Sentry does not have any native method. After further
  ...
  panics of the monitored process. When a panic is seen, it's reported back to
