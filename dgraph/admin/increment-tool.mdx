...
yet exist, then it will be created starting at counter 0.
...
Run a read-only query for the counter predicate and does not run a mutation to
increment it:
...
Run a best-effort query for the counter predicate and does not run a mutation to
increment it:
