...
![Jaeger UI](/images/dgraph/jaeger-ui.png)

Every trace has your custom tags set under the “Process” section of each span:

![Jaeger Query](/images/dgraph/jaeger-server-query.png)

Filter traces by tags matching `env=qa`:

![Jaeger JSON](/images/dgraph/jaeger-json.png)

![Jaeger Query Result](/images/dgraph/jaeger-server-query-2.png)
