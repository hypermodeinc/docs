...
To see Collections in action, explore the example on GitHub: [Example Project](https://github.com/hypermodeinc/functions-as/tree/main/examples/collection). This example demonstrates how to manage a collection of products using Hypermode's Collections and Models APIs, covering core CRUD operations, embedding usage, search capabilities, and vector-based comparisons.
...
<Note>
  If the key already exists, the function will overwrite the previous entry; if
...
<ResponseField name="key" type="string">
  The unique identifier for the item in the namespace. If null, a UUID will be
  generated.
</ResponseField>
