---
title: About AssemblyScript
sidebarTitle: About
description: "Introduction to AssemblyScript -- a TypeScript-like language"
mode: "wide"
---
...
<Note>
  If your not familiar with signed vs unsigned integers, signed means it can be
  `positive` or `negative`, but unsigned means it can *only be* `positive`
</Note>
...
<Note>
  If you have any questions, feel free to join the [AssemblyScript
  Discord](https://discord.gg/assemblyscript/) to ask questions
</Note>
