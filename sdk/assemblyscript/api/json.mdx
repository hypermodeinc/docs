...
AssemblyScript doesn't come with support for serializing and deserializing JSON, so instead, we use [json-as](https://github.com/JairusSW/as-json).
...
```typescript
// 😊 Type information and intellisense!
@json
class Vec3 {
  x: f64 = 0.0;
  y: f64 = 0.0;
