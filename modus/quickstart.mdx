...
In this quickstart we'll show you how to get set up with Modus and its CLI and build a simple app
that fetches a random quote from an external API. You'll learn how to use the basic components of a
Modus app and how to run it locally.
...
<Steps>
  ...
  <Step title="Add a function">
    ...
    <Tabs>
      <Tab title="Go">
        To add a function, create a new file in the `src` directory with the following code:
