...
The Console API allows you to capture information from your functions, such as errors and other information that can
help you debug your functions.
...
[`console`](https://www.assemblyscript.org/stdlib/console.html) object, but directs the output to Hypermode as follows:
...
For your reference, an example that uses the Console APIs is available on GitHub in the `hypermodeinc/functions-as`
repository, at [/examples/simple](https://github.com/hypermodeinc/modus/tree/main/sdk/assemblyscript/examples/simple).
