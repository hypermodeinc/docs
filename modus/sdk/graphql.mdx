...
Hypermode's GraphQL APIs allows you to securely call and fetch data from any GraphQL endpoint. After
[defining a host](../app-manifest#hosts) for the GraphQL endpoint in your project's manifest, you can use the following
APIs to interact with the data.

## Example project

For your reference, A complete example for using the GraphQL APIs is available on GitHub in the
`hypermodeinc/functions-as` repository, at
[/examples/graphql](https://github.com/hypermodeinc/modus/tree/main/sdk/assemblyscript/examples/graphql).
