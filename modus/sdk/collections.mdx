...
<Note>
  Modus uses the same embedder for both inserting text into the collection, and for the text used when searching the
  collection.
</Note>
...
<Note>
  Modus uses the same embedder for both inserting text into the collection, and for the vector used when searching the
  collection.
</Note>
