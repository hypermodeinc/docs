...
To see Collections in action, explore the [collection example in AssemblyScript](https://github.com/hypermodeinc/modus/tree/main/sdk/assemblyscript/examples/collection) or [collection example in GoLang](https://github.com/hypermodeinc/modus/tree/main/sdk/go/examples/collections) on GitHub. This example demonstrates how to manage a collection of products using Hypermode's Collections and Models APIs, covering core create,read,update, and delete operations, embedding usage, search capabilities, and vector-based comparisons.
