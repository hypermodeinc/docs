...
The Modus CLI automatically downloads various files and dependencies to the following directory:
...
For example, if your local permissions on Windows don't allow creating a directory in the root of your user profile, you can try a different location.
...
_Note, the Windows `setx` command makes the environment variable setting permanent._
