...
| Functions              | Agents                   |
| ---------------------- | ------------------------ |
| Field operatives       | Agents                   |
| Single mission focus   | Long-term assignments    |
| No operational memory  | Complete mission history |
| Fast tactical strikes  | Strategic operations     |
| Independent operations | Coordinated campaigns    |
