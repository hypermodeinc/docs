...
Hypermode follows [GraphQL's standard definition language](https://graphql.org/learn/schema/). Simply add the [directive](https://graphql.org/learn/queries/#directives) `@lambda @hm_function` to register the function on the project's endpoint.
...
function signature needs to match