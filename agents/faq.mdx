...
**Do I need to be a programmer to use Hypermode Agents?**

No. Hypermode Agents is designed for everyone, even if you have no coding
background.

**What can I use an AI agent for?**
...
- **Tell the agent what not to do**
  - Example: “Do not provide legal or medical advice. Do not make up information
    if you are unsure.”
- **Test and revise**
