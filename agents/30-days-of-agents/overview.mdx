...
<Note>
  **Currently available Days 1-10** we're launching with the first two weeks to
  get you started with immediate value and custom agent creation. Stay tuned for
  the remaining weeks as we roll out the complete 30-day program.
</Note>
...
<CardGroup cols={2}>
  <Card
    title="Day 6 - Unlock Hypermode Pro"
    href="/agents/30-days-of-agents/day-6"
  >
    Join the Discord community and unlock exclusive Hypermode Pro access with 2,000+ integrations.
  </Card>

<Card title="Day 7 - Meet Concierge" href="/agents/30-days-of-agents/day-7">
  Discover Concierge, the AI agent that builds AI agents. Create your first
  custom agent from natural language.
</Card>
...
>
  Transform successful workflows into reusable tasks that scale your agent's
  capabilities.
</Card>

  <Card title="Day 10 - Week 2 Reflection" href="/agents/30-days-of-agents/day-10">
    Reflect on your transformation from agent user to agent builder and prepare for advanced development.
  </Card>
</CardGroup>

**Key takeaways:**

- Custom agent creation with Concierge
- Advanced integration strategies and multi-tool workflows
- Community engagement and knowledge sharing
- Task creation and workflow reuse
- Builder identity and strategic thinking
...
**Week 4 production deployment** enterprise integration and scaling strategies

**Week 5 optimization & export** performance tuning and code export for
production systems
...
- Weeks 3-5: ~20 minutes (advanced integration and streamlining) _[Coming soon]_
