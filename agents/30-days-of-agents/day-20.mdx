...
INFLUENCES) **Properties**: Attributes of nodes and relationships (name, date,
strength) **Labels**: Categories for nodes (Person, Company, Technology)
...
GraphRAG enables reasoning that traditional RAG cannot:
