...
your AI-powered personal assistant agent that's ready to work from the moment
you sign up.
...
<Info>
  Google Calendar is already preconfigured in Sidekick. Want access to 2,000+
  more connections? [Upgrade to Hypermode Pro](/agents/connections).
</Info>
...
**Action** - Created the calendar event, not just provide suggestions
