...
<Card>
  ...
  Use this app to create a Discord source that emits messages from your guild to
...
<Card>
  <div className="flex items-center gap-2">
    <img
      src="/images/agents/connections/icons/pushover.svg"
      alt="Pushover"
      width={24}
      height={24}
    />
    <span className="text-lg font-semibold">Pushover</span>
  </div>
  Pushover is a simple push notification service that integrates easily into web
  apps like IFTTT, network monitoring systems, shell scripts, servers, and more.
</Card>
