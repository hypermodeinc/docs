...
- **Domain expertise:** Performance varies by domain (e.g., creative writing,
  code, scientific analysis). Review model benchmarks or test with your own
  examples.
...
- **Embeddings:** For semantic search or similarity, consider embedding models.
  These are not for text generation.
