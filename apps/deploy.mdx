...
- A linked GitHub repository (for automatic deployments)
...
This opens your browser and authenticates you with Hypermode, storing your
credentials locally for future deployments.

## Linking Your Repository

To enable automatic deployments, link your Modus app repository to Hypermode:
...
- Creates a Hypermode app linked to your repository

## Deployment Methods

### Automatic Deployment via Git

The recommended approach is automatic deployment through Git. When you link your
repository, Hypermode automatically deploys your app when you push to the `main`
branch.
...
For immediate deployments or testing, you can deploy directly from your local
environment:
...
Ensure your `modus.json` is properly configured for production:
...
6. **Health Checks**: Verifies the deployment is healthy and responsive
...
For zero-downtime deployments, Hypermode supports blue-green deployment
patterns:
...
hyp promote staging production
```
