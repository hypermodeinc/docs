...
Need a bespoke model? You can include a model from [Hugging Face](https://huggingface.co/) in your [app manifest](/modus/app-manifest) and Hypermode runs and manages it for you.
...
By default, if the model you use is available as a shared model, your app uses these shared models at runtime. You can override this default behavior by setting `dedicated: true` on your model in the [app manifest](/modus/app-manifest).
