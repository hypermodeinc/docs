...
- Read your Slack channels and manage team communications
- Create Linear issues when bugs are found
- Query GitHub repositories and analyze pull requests
- Access your deployment platform deployments and build logs
...
**What it does**: monitors GitHub pull requests, provides code reviews, and
manages Linear issues.

```text
Training conversation:

You: "When a new PR is created, analyze it for security issues and code quality"

Agent: "I'll check each PR for common vulnerabilities and style issues.
        Should I also verify tests are included?"

You: "Yes, and if tests are missing, create a Linear issue"

Agent: "Got it. I'll analyze PRs, check for tests, and create Linear tickets
        when needed."

You: "Also check commit messages for our convention"

Agent: "Perfect. I'll verify commit messages follow your team's standards
...
### Slack productivity agent

**What it does**: monitors Slack channels, manages team communications, and
tracks project updates.

```text
Training conversation:

You: "Monitor #engineering channel for deployment mentions and summarize
     weekly progress"

Agent: "I'll watch for deployment keywords. Should I track specific projects?"

You: "Yes, look for mentions of our main products and their status updates"

Agent: "I'll categorize updates by project and create weekly summaries."

You: "Also respond to direct questions about project status"

Agent: "I'll maintain context about recent discussions and provide helpful
...
**What it does**: monitors deployment platform deployments, analyzes build logs,
and reports on app health.

```text
Training conversation:

You: "Watch our deployment platform deployments and alert me when builds fail"

Agent: "I'll monitor your deployment status. Should I analyze the error logs?"

You: "Yes, and suggest potential fixes when possible"

Agent: "I'll examine build logs, identify common failure patterns, and
        recommend solutions."

You: "Also track deployment frequency and success rates"

Agent: "I'll maintain metrics on your deployment pipeline and provide
        regular health reports."
```

**Current capabilities**:

- Deployment platform project monitoring
...
Slack Agent → Focused on team communication and coordination
     ↓
Deployment Agent → Optimized for deployment monitoring and infrastructure
```
...
- **Generative Pre-trained Transformer (GPT)-4.1**: Latest OpenAI model for
  complex reasoning and code analysis
...
```text
You: "Use Claude for the writing tasks and Generative Pre-trained Transformer (GPT)-4.1 for code analysis"

Agent: *Adapts model usage based on task type*
"I'm now using Claude for documentation and Generative Pre-trained Transformer (GPT)-4.1 for technical analysis.
...
- **Deployment Agent**: Deployment monitoring only (no user data access)
...
✅ "Build an agent that monitors our GitHub PRs and creates Linear issues for bugs"
```
...
Threads currently supports:

### Integrated tools

- **GitHub**: Repository management, pull request analysis, commit tracking
- **Slack**: Channel monitoring, user management, message handling
- **Linear**: Issue creation and tracking
- **Deployment platform**: Deployment monitoring, build log analysis
- **Web search**: Web search and content discovery
- **Time functions**: UTC time, scheduling capabilities

### Agent features

- **Persistent memory**: Agents remember training across sessions
- **Tool integration**: Seamless connection to external services
- **Multi-model support**: Choose the best model for each task
- **Structured outputs**: Agents can generate formatted responses
- **Error handling**: Robust error recovery and user feedback

### Development workflow

- **Real-time training**: Immediate feedback and iteration
- **Context preservation**: Conversation history maintained
- **Task generation**: Convert conversations into reusable workflows
- **Production deployment**: Direct path from conversation to live agent
...
```text
Agent: "I notice we've done this GitHub workflow 3 times. Should I save it
        as a standard automation?"

You: "Yes, make it available to the whole team"

Agent: "Automation created: 'PR Review Process' - available in your
        team workspace"
```
...
```text
GitHub Agent: "Found 5 PRs needing review. Delegating to Code Review Agent..."
Review Agent: "Analysis complete. Passing results to Linear Agent for issue creation..."
Linear Agent: "Issues created. Notifying team through Slack Agent..."
```

### Advanced scheduling (coming soon)
...
- Monthly team productivity analysis
