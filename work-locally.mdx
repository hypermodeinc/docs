...
Building Modus apps is even easier when you add Hypermode. The Hyp CLI extends the [local Modus experience](/modus/modus-cli) with access to Hypermode-hosted models defined in your [app's manifest](/modus/app-manifest) for rapid experimentation with new AI models.
